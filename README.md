...
Extract your project folder:

CROP-AND-FERTILISER-master
...
(or install manually if requirements file is not present)
...
Click Predict Crop
The system displays the most suitable crop
...
🗺️ Region-based crop prediction
👨‍💻 Author
